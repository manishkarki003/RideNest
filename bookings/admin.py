...
class BookingAdmin(admin.ModelAdmin):
    ...
    readonly_fields = ("booking_reference", "renter", "owner", "vehicle", "pickup_date", "return_date", "total_days", "rental_price_per_day", "subtotal", "security_deposit", "total_amount", "booking_status", "created_at", "updated_at")
