...
SECRET_KEY = os.environ.get("DJANGO_SECRET_KEY", "django-insecure-development-key-change-before-production")
...
# SQLite is used locally. Set POSTGRES_DB and related variables to use PostgreSQL.
